<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="EditCustomerNathan.Edit" %>
...
<body>
    <form id="form1" runat="server">
         <asp:Panel ID="pnlCon" runat="server" Height="287px" Width="700px">
            ...
            <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" style="z-index: 1; left: 352px; top: 178px; position: absolute" Text="Confirm Changes" />
            <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 555px; top: 221px; position: absolute" Text="Go To Main Page" OnClick="btnEdit_Click" />
            <asp:Label ID="lblError" runat="server" Text="&quot;&quot;" style="z-index: 1; left: 356px; top: 63px; position: absolute; height: 26px; width: 48px; right: 687px;"></asp:Label>
            <asp:DropDownList ID="ddCust" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddCust_SelectedIndexChanged"></asp:DropDownList>
         </asp:Panel>
    </form>
</body>
</html>
